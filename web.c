...
"#tabs{display:flex;align-items:center;background:#222;border-bottom:1px solid #444;}\n"
...
"#theme-toggle{margin-left:auto;margin-right:10px;background:transparent;color:inherit;border:1px solid currentColor;border-radius:4px;padding:0 8px;cursor:pointer;font-size:13px;line-height:22px;height:24px;opacity:0.6;}\n"
...
/* Light theme overrides (dark stays default; toggled via html.light class). */
"html.light body{background:#f8fafc;color:#1e293b;}\n"
"html.light #tabs{background:#ffffff;border-bottom-color:#cbd5e1;}\n"
"html.light #tabs button{color:#64748b;}\n"
"html.light #tabs button.active{color:#0284c7;border-bottom-color:#0284c7;}\n"
"html.light .pane{background:#ffffff;}\n"
"html.light h2{color:#0284c7;border-bottom-color:#cbd5e1;}\n"
"html.light th{color:#0284c7;}\n"
"html.light th,html.light td{border-bottom-color:#e2e8f0;}\n"
...
"html.light #config button{background:#e0f2fe;color:#0284c7;border-color:#0284c7;}\n"
